...
export const ICON_ASC = 'rounded-up';
export const ICON_BRAND = 'ticket';
export const ICON_BUSY = 'refresh';
export const ICON_COMMENT = 'comment';
export const ICON_DESC = 'rounded-down';
export const ICON_ERROR = 'warning-alt';
export const ICON_LIST = 'listing-box';
export const ICON_LOGIN = 'login';
export const ICON_LOGOUT = 'logout';
export const ICON_PARTICIPANTS = 'group-students';
export const ICON_SEARCH = 'ui-search';
export const ICON_STOP = 'ui-block';